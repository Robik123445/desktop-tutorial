diff --git a//dev/null b/cam_slicer/ai/analyzers.py
index 0000000000000000000000000000000000000000..640917b4f34d1f2229654da8fc7cd4442520d0ed 100644
--- a//dev/null
+++ b/cam_slicer/ai/analyzers.py
@@ -0,0 +1,37 @@
